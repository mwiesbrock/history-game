...
export const FOOD_DECAY_PER_DAY = 20;
export const REST_DECAY_PER_DAY = 25;
export const MENTAL_DECAY_PER_DAY_BASE = 4;

export const LOW_NEED_THRESHOLD = 20;
export const LOW_NEED_MENTAL_PENALTY_PER_DAY = 8;

export const RESTRAINED_MENTAL_PENALTY_PER_DAY = 14;
export const AGITATED_MENTAL_PENALTY_PER_DAY = 5;
export const ATTENDANT_MENTAL_BONUS_PER_DAY = 3;
